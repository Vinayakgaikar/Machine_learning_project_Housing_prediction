...
import tarfile                  #Use to extract zip file
import numpy as np              
...
class DataIngestion :
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            housing_data_frame["income_cat"] = pd.cut(
                ...
                labels=[1,2,3,4,5]                           #bins=np.inf means any value greater than 6.0 falls into label 5
            )
            ...
            if strat_train_set is not None:
                ...
                strat_train_set.to_csv(train_file_path,index=False)                      #To save it csv file
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:         #combine above all function in this one function
        try:
